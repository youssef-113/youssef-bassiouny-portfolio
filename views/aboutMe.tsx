...
const Skills: React.FC = () => {
  ...
  const bioText = "RTM & Operations Data Analyst at Outsourcing Skill with expertise in real-time campaign monitoring, VICIdial operations, and automated dashboard development using Power BI, Python, and SQL. Generative AI Engineer and ML Engineer with hands-on experience delivering production AI systems across sales intelligence, health tech, and business automation. Technical stack spans LLM fine-tuning (LoRA, PEFT), RAG pipelines, autonomous agents, Power BI, Streamlit, PyTorch, and Hugging Face. Built and deployed end - to - end ML pipelines processing 20K + records with measurable business outcomes: 35 % efficiency gains, 50 % reduction in manual processes, 91 % model accuracy.Currently completing advanced DEPI specialization in Generative and Agentic AI.INJAZ Egypt Product Management trainee. Open to AI / ML engineering roles, data science positions, and remote freelance engagements.Available immediately."
